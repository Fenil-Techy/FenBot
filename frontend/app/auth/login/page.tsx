  ...
  return (
    <div className="bg-white shadow-2xl rounded-3xl border border-slate-100 p-8 sm:p-10 w-full space-y-6">
      ...
      <div className="space-y-2 text-center">
        ...
        <p className="text-sm text-slate-500 font-medium">Log in to manage your AI agents</p>
      </div>
        ...
        <div className="space-y-1.5">
          <div className="flex items-center justify-between">
            ...
            <a
              ...
              className="text-xs font-semibold text-[#E8281E] hover:underline"
            >
              Forgot password?
            </a>
          </div>
      ...
      <p className="text-center text-sm text-slate-500 font-medium">
        ...
        <Link href="/auth/signup" className="font-bold text-[#E8281E] hover:underline">
          Sign up
        </Link>
      </p>
    </div>
